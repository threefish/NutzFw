            ...
            var tour = new Tour({
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        template: FLOWABLE_EDITOR_TOUR._buildStepTemplate(false, true, false, 400, '/static/flowable-modeler/images/tour/open-group.gif'),
                    ...
                    },
                    {
                        ...
                        template: FLOWABLE_EDITOR_TOUR._buildStepTemplate(false, true, false, 720, '/static/flowable-modeler/images/tour/tour-dnd.gif'),
                        onNext: FLOWABLE_EDITOR_TOUR._buildOnNextFunction(tourStepDomElements[0])
                    },
                    {
                ...
                steps: [
                    {
                        ...
                        title: translations[0],
                        content: translations[1],
                        template: FLOWABLE_EDITOR_TOUR._buildStepTemplate(false, false, true, 500, '/static/flowable-modeler/images/tour/sequenceflow-bendpoint.gif'),
                        onNext: FLOWABLE_EDITOR_TOUR._buildOnNextFunction(tourStepDomElements[0])
                    }
                ],
