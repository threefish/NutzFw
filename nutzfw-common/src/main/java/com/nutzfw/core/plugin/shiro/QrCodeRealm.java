 ...
 */
@IocBean
public class QrCodeRealm extends AbstractAuthorizingRealm {

    public QrCodeRealm() {
        setAuthenticationTokenClass(QrCodeToken.class);
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken authenticationToken) throws AuthenticationException {
        this.initServices();
        QrCodeToken token = (QrCodeToken) authenticationToken;
