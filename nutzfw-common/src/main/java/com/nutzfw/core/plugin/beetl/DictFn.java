 ...
 * <p>
 * ${dict("holiday_type",false,"form-control","leave.leaveType","id")}
 * <p>
 * 如果还需要设置自定义HTML属性需要设置END字符参数隔开，例子参考
 * <p>
 * ${dict("holiday_type",false,"form-control","leave.leaveType","id","END","v-model='test.xxx'")}
 * ${dict("holiday_type","END","v-model='test.xxx'")}
 * <p>
 * 不能为单例模式，否则会出现问题
 */
