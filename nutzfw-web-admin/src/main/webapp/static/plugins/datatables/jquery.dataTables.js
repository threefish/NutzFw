...
(/** @lends <global> */function (window, document, undefined) {
	 ...
	 *    } );
        ...
        function _fnDraw(oSettings) {
            ...
            //增加快速跳转页功能 黄川
            var nowPage = (oSettings._iDisplayStart + oSettings._iDisplayLength) / oSettings._iDisplayLength;
            $('#' + oSettings.sTableId + '_info input').val(parseInt(nowPage));
            $('#' + oSettings.sTableId + '_info input').blur(function () {
                var maxPage = oSettings._iRecordsTotal / oSettings._iDisplayLength;
                if ($(this).val() && $(this).val() > 0) {
                    var redirectpage = $(this).val() - 1;
                } else {
                    var redirectpage = 0;
                }
                if(redirectpage>= maxPage){
                    redirectpage = maxPage-1;
                }
                $("#" + oSettings.sTableId).dataTable().fnPageChange(redirectpage);
            });
