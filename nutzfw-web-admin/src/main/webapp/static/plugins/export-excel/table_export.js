...
;(function (window, undefined) {
    ...
    $.fn.tableExport = function (options) {
        ...
        var settings = $.extend({}, $.fn.tableExport.defaults, options),
            ...
            appendToBtn=settings.appendToBtn,
        ...
        this.each(function () {
            ...
            function checkCaption(exportButton) {
                var $btn = $('#'+appendToBtn);
                $btn ? $btn.append(exportButton) : $el.prepend('<span class="' + bootstrapSpacing + settings.position + '">' + exportButton + '</span>');
            ...
            function createObjButton(dataObject, myContent, myClass) {
                var $obj =  (  settings.className ? $("."+settings.className) : $("#"+settings.id));
                $obj.attr("data-fileblob",dataObject)//.addClass(myClass);
               /* //if(!$("."+myClass)) {
